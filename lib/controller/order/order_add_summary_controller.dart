...
import 'package:app01/data/datasource/remote/order_data/order_addsummary_data.dart';
import 'package:get/get.dart';

abstract class OrderAddSummaryController extends GetxController {
  intailData();
  SendRequest();
  ListAdd();
  goBack();
...
class OrderAddSummaryControllerImp extends OrderAddSummaryController {
  OrderAddSummaryData orderAddData = OrderAddSummaryData(Get.find());
  List data = [];
  ...
  SendRequest() async {
    ...
    var response = await orderAddData.postData(
      OrderStartDateTime,
      OrderEndDateTime,
      OrderTitle,
      OrderDisc,
    ...
    print("====Step#1: [add data to response]");
    print(response);
    statusRequest = handlingData(response);
    print("====Step#2: [handlingData(response)]");
