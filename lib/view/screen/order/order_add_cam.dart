import 'package:app01/controller/order/order_add_cam_controller.dart';
...
class OrderAddCam extends StatelessWidget {
  OrderAddCam({super.key});

  @override
  Widget build(BuildContext context) {
    OrderAddCamControllerImp controllerPub = Get.put(OrderAddCamControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: Text("Order Adding Camera Equipment's"),
      ...
      drawer: MyDrawer(),
      body: GetBuilder<OrderAddCamControllerImp>(
                ...
                children: [
                  Container(
                    ...
                    child: CustomTitleHome(
                      title: 'Add Details Of Camera Equipments',
                    ),
                  ),
                  SizedBox(
                    height: 20,
