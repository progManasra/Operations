import 'package:app01/controller/order/order_edit_light_controller.dart';
...
class OrderEditLight extends StatelessWidget {
  OrderEditLight({super.key});

  @override
  Widget build(BuildContext context) {
    OrderEditLightControllerImp controllerPub = Get.put(OrderEditLightControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: Text("Order Edit Light Equipment's"),
      ...
      drawer: MyDrawer(),
      body: GetBuilder<OrderEditLightControllerImp>(
                ...
                children: [
                  Container(
                    ...
                    child: CustomTitleHome(
                      title: 'Edit Details Of Light Equipments',
                    ),
                  ),
                  SizedBox(
                    height: 20,
