...
import 'package:app01/controller/order/order_edit_location_transportation_controller.dart';
...
class OrderEditLocationAndTransportation extends StatelessWidget {
  OrderEditLocationAndTransportation({super.key});

  @override
  Widget build(BuildContext context) {
    OrderEditLocationAndTransportationControllerImp controllerPub =
        Get.put(OrderEditLocationAndTransportationControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          "Order Edit Location Equipment's",
      ...
      drawer: MyDrawer(),
      body: GetBuilder<OrderEditLocationAndTransportationControllerImp>(
                ...
                children: [
                  Container(
                    ...
                    child: CustomTitleHome(
                      title: 'Edit Details Of Location And Transportation',
                    ),
                  ),
                  SizedBox(
                    height: 20,
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton2(
                        hint: Text(
                          // "Select",
                          '${controller.myServices.sharedPreferences.getString('initDefaultselectedItemsLocation').toString()}',
                          style: TextStyle(
                            fontSize: 14,
