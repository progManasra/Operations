import 'package:app01/controller/order/order_edit_audio_controller.dart';
...
class OrderEditAudio extends StatelessWidget {
  OrderEditAudio({super.key});

  @override
  Widget build(BuildContext context) {
    OrderEditAudioControllerImp controllerPub = Get.put(OrderEditAudioControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: Text("Order Edit Audio Equipment's"),
      ...
      drawer: MyDrawer(),
      body: GetBuilder<OrderEditAudioControllerImp>(
                ...
                children: [
                  Container(
                    ...
                    child: CustomTitleHome(
                      title: 'Edit Details Of Audio Equipments',
                    ),
                  ),
                  SizedBox(
                    height: 20,
