import 'package:app01/controller/order/order_edit_equipment_controller.dart';
...
class OrderEditEquipment extends StatelessWidget {
  OrderEditEquipment({super.key});

  @override
  Widget build(BuildContext context) {
    OrderEditEquipmentControllerImp controllerPub = Get.put(OrderEditEquipmentControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: Text("Order Edit General Equipment's"),
      ...
      drawer: MyDrawer(),
      body: GetBuilder<OrderEditEquipmentControllerImp>(
                ...
                children: [
                  Container(
                    ...
                    child: CustomTitleHome(
                      title: 'Edit Details Of General Equipments',
                    ),
                  ),
                  SizedBox(
                    height: 20,
