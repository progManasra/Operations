import 'package:app01/controller/order/order_edit_employee_controller.dart';
...
class OrderEditEmployee extends StatelessWidget {
  OrderEditEmployee({super.key});

  @override
  Widget build(BuildContext context) {
    OrderEditEmployeeControllerImp controllerPub = Get.put(OrderEditEmployeeControllerImp());
    return Scaffold(
      appBar: AppBar(
        title: Text("Order Edit General Employee's"),
      ...
      drawer: MyDrawer(),
      body: GetBuilder<OrderEditEmployeeControllerImp>(
                ...
                children: [
                  Container(
                    ...
                    child: CustomTitleHome(
                      title: 'Edit Details Of General Employees',
                    ),
                  ),
                  SizedBox(
                    height: 20,
